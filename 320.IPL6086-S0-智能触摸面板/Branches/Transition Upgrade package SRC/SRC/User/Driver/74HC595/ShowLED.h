...
#define LED1_RVS     GPIOx_Rvrs(PORT_LED_B, PIN_L1)
#define LED2_RVS     GPIOx_Rvrs(PORT_LED_B, PIN_L2)
#define LED3_RVS     GPIOx_Rvrs(PORT_LED_B, PIN_L3)
#define LED4_RVS     GPIOx_Rvrs(PORT_LED_B, PIN_L4)
#define LED5_RVS     GPIOx_Rvrs(PORT_LED_B, PIN_L5)
#define LED6_RVS     GPIOx_Rvrs(PORT_LED_A, PIN_L6)
